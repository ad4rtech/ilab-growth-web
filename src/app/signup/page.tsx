...
export default function SignUpPage() {
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    if (error) {
      ...
      } else if (error.code?.includes("PASSWORD") || error.status === 400) {
      ...
      <div className="hidden lg:flex lg:w-[42%] flex-col justify-between bg-blue-700 text-white p-12">
        <div>
          ...
          <p className="mt-6 text-blue-100">
            Join 12,000+ African entrepreneurs learning, selling, and scaling
            with iLab Growth.
          </p>
          ...
          <ul className="mt-10 space-y-5">
            <li className="flex items-start gap-3">
              ...
              <span className="text-sm text-blue-50">
                Free access to select courses &amp; resources
              </span>
            </li>
            <li className="flex items-start gap-3">
              <span className="flex h-8 w-8 flex-none items-center justify-center rounded-lg bg-blue-600">
            ...
            <li className="flex items-start gap-3">
              ...
              <span className="text-sm text-blue-50">
                Secure checkout — pay in your local currency
              </span>
            </li>
            <li className="flex items-start gap-3">
              <span className="flex h-8 w-8 flex-none items-center justify-center rounded-lg bg-blue-600">
              ...
              <span className="text-sm text-blue-50">
                Join a community of 12,000+ entrepreneurs
              </span>
            </li>
          </ul>
        </div>
           ...
           <Select value={country} onValueChange={(value) => value !== null && setCountry(value)}>
            ...
            <div className="flex items-start gap-2 rounded-lg border bg-muted/40 p-3">
              ...
              <p
                ...
                className="text-xs text-muted-foreground"
              >
                M-Pesa users: create your account first to link purchases
